            ...
            public void onResponse(String response) {
                try{
                    ...
                    if(!error){
                        ...
                        Data_from_server title = new Data_from_server(tit,null,1,null,null);
                        data_from_servers.add(title);
                        Data_from_server title_image = new Data_from_server(null ,ADRESS + tit_image,2,null,null);
                        data_from_servers.add(title_image);
                        Data_from_server story = new Data_from_server(sto,null,3,null,null);
                        data_from_servers.add(story);
                        Data_from_server image = new Data_from_server(null,ADRESS + ima,4,null,null);
