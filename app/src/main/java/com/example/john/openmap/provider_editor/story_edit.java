...
public class story_edit extends Activity{
    EditText story_maker;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.story_maker);

        story_maker = findViewById(R.id.tool_for_make_story);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(story_edit.this, providers.class);
    ...
    StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_STORY, new Response.Listener<String>() {
        ...
        public void onResponse(String response) {
            try {
                ...
                String story = user.getString("story");
                if(upload_state){
                    go_to_provider();
                    story_maker.setText(story);
                }else{
